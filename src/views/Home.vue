<template>
  <main v-if="!loading">
    ...
    <button
      v-if="status.Country"
      class="bg-blue-700 text-white rounded p-3 mt-10 focus:outline-none hover:bg-green-600 animate-wiggle"
...
<!--Imports, make sure to put them into the export components-->
<script>
